		...
		<div class="container">
			...
			<div class="grid_3">
				<aside>
					<ul class="sideNav hideBlock">
						...
						<li class="current"><a href="trialProduction"><i class="fa fa-cubes"></i>試產</a></li>
	        ...
	        <div class="grid_9">
				<section class="ventureTypesTitle hideBlock">
					<h2><img alt="創業業種圖示" src="images/type.png">試產</h2>
				</section>

				<form class="formset clearfix" id="sendForm" method="POST" action="addExpenditure">
					<input type="hidden" name="subClass" value="215">
					...
					<fieldset id="BusinessCard" class="fieldset">
					  	...
					  	<input type="hidden" name="dynamicPayMoney[${index}].record" value="${card.record}">
						  	...
						  	<div class="field">
						  		<button type="button" class="deletebutton delCardBtn" data-id="${index}" data-record="${card.record }" data-item="2151"><i class="fa fa-times"></i> 刪除</button>
						  	</div>					  		
					  	</div>
					...
					<fieldset id="Lawyer" class="fieldset">
					  	...
					  	<input type="hidden" name="dynamicPayMoney[${index}].record" value="${lawyer.record}">
						  	...
						  	<div class="field">
						  		<button type="button" class="deletebutton delLawyerBtn" data-id="${index}" data-record="${lawyer.record }" data-item="2152"><i class="fa fa-times"></i> 刪除</button>
						  	</div>					  		
					  	</div>
					  	<c:set var="index" value="${index+1}" />
					  	</c:forEach>
