...
<body class="bg-login">
	...
	<div class="container">	
		<div class="prefix_4 grid_4 suffix_4">
			<form id="sendForm" action="modiPassword" method="post" class="register_form clearfix">
				<ul>
					...
					<li>
						...
						<input type="password" name="oldPassword" id="oldPassword" placeholder="請輸入舊密碼" class="textbox key">
