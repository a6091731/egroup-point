		...
		<div class="container">
			...
			<div class="grid_3">
				<aside>
					<ul class="sideNav hideBlock">
						...
						<li class="current"><a href="equipmentBuild"><i class="fa fa-building-o"></i>生產設備建置</a></li>
	        ...
	        <div class="grid_9">
				<section class="ventureTypesTitle hideBlock">
					<h2><img alt="創業業種圖示" src="images/type.png">生產設備建置</h2>
				</section>

				<form class="formset clearfix" id="sendForm" method="POST" action="addExpenditure">
					<input type="hidden" name="subClass" value="214">
					...
					<fieldset id="BusinessCard" class="fieldset">
					  	...
					  	<input type="hidden" name="dynamicPayMoney[${index}].ID" value="2141">
					  	<input type="hidden" name="dynamicPayMoney[${index}].record" value="${card.record}">
						  	...
						  	<div class="field">
						  		<button type="button" class="deletebutton delCardBtn" data-id="${index}" data-record="${card.record }" data-item="2141"><i class="fa fa-times"></i> 刪除</button>
						  	</div>					  		
					  	</div>
					...
					<fieldset id="Lawyer" class="fieldset">
					  	...
					  	<div id="paymoney_${index}">
					  	<input type="hidden" name="dynamicPayMoney[${index}].ID" value="2142">
					  	<input type="hidden" name="dynamicPayMoney[${index}].record" value="${lawyer.record}">
						  	...
						  	<div class="field">
						  		<button type="button" class="deletebutton delLawyerBtn" data-id="${index}" data-record="${lawyer.record }" data-item="2142"><i class="fa fa-times"></i> 刪除</button>
						  	</div>					  		
					  	</div>
					  	<c:set var="index" value="${index+1}" />
					  	</c:forEach>
