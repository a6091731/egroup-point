		...
		<div class="container">
			...
			<div class="grid_3">
				<aside>
					<ul class="sideNav hideBlock">
						...
						<li class="current"><a href="placeComplete"><i class="fa fa-certificate"></i>營業場所完工</a></li>
	        ...
	        <div class="grid_9">
				<section class="ventureTypesTitle hideBlock">
					<h2><img alt="創業業種圖示" src="images/type.png">營業場所完工</h2>
				</section>

				<form class="formset clearfix" id="sendForm" method="POST" action="addExpenditure">
					<input type="hidden" name="subClass" value="212">
					...
					<fieldset id="BusinessCard" class="fieldset">
					  	...
					  	<input type="hidden" name="dynamicPayMoney[${index}].record" value="${card.record}">
						  	...
						  	<div class="field">
						  		<button type="button" class="deletebutton delCardBtn" data-id="${index}" data-record="${card.record }" data-item="2125"><i class="fa fa-times"></i> 刪除</button>
						  	</div>					  		
					  	</div>
					...
					<fieldset id="Lawyer" class="fieldset">
					  	...
					  	<input type="hidden" name="dynamicPayMoney[${index}].record" value="${lawyer.record}">
						  	...
						  	<div class="field">
						  		<button type="button" class="deletebutton delLawyerBtn" data-id="${index}" data-record="${lawyer.record }" data-item="2126"><i class="fa fa-times"></i> 刪除</button>
						  	</div>					  		
					  	</div>
					  	<c:set var="index" value="${index+1}" />
					  	</c:forEach>
					...
					<fieldset id="Accountants" class="fieldset">
					  	...
					  	<input type="hidden" name="dynamicPayMoney[${index}].record" value="${account.record}">
						  	...
						  	<div class="field">
						  		<button type="button" class="deletebutton delAccountBtn" data-id="${index}" data-record="${account.record }" data-item="2127"><i class="fa fa-times"></i> 刪除</button>
						  	</div>					  		
					  	</div>
					  	<c:set var="index" value="${index+1}" />
					  	</c:forEach>
					...
					<div class="mt50px">
						<button type="submit" class="nextStepButton"><span class="next">下一步，填寫人員到位<i class="fa fa-arrow-right"></i></span></button>
						<button type="button" class="nextStepButton mR"><a href="founded"><span class="next">上一步，填寫公司成立<i class="fa fa-arrow-left"></i></span></a></button>&nbsp;&nbsp;
					</div>
				  </form>
			</div>
		</div>			
